...
step3 = importlib.import_module("tml-solutions.myawesometmlsolution-ba1d.tml_read_LOCALFILE_step_3_kafka_producetotopic_dag-myawesometmlsolution-ba1d")
...
with DAG(
    dag_id="solution_preprocessing_ml_ai_dag-myawesometmlsolution-ba1d",
