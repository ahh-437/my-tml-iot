...
step3 = importlib.import_module("tml-solutions.iotsolution-grpc-ba1d.tml_read_LOCALFILE_step_3_kafka_producetotopic_dag-iotsolution-grpc-ba1d")
...
with DAG(
    dag_id="solution_preprocessing_ml_ai_dag-iotsolution-grpc-ba1d",
