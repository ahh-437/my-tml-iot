...
step1 = importlib.import_module("tml-solutions.tml-server-v1-plugin-ba1d.tml_system_step_1_getparams_dag-tml-server-v1-plugin-ba1d")
step2 = importlib.import_module("tml-solutions.tml-server-v1-plugin-ba1d.tml_system_step_2_kafka_createtopic_dag-tml-server-v1-plugin-ba1d")
step3 = importlib.import_module("tml-solutions.tml-server-v1-plugin-ba1d.tml_read_RESTAPI_step_3_kafka_producetotopic_dag-tml-server-v1-plugin-ba1d")
step4 = importlib.import_module("tml-solutions.tml-server-v1-plugin-ba1d.tml_system_step_4_kafka_preprocess_dag-tml-server-v1-plugin-ba1d")
step5 = importlib.import_module("tml-solutions.tml-server-v1-plugin-ba1d.tml_system_step_5_kafka_machine_learning_dag-tml-server-v1-plugin-ba1d")
step6 = importlib.import_module("tml-solutions.tml-server-v1-plugin-ba1d.tml_system_step_6_kafka_predictions_dag-tml-server-v1-plugin-ba1d")
step7 = importlib.import_module("tml-solutions.tml-server-v1-plugin-ba1d.tml_system_step_7_kafka_visualization_dag-tml-server-v1-plugin-ba1d")
step8 = importlib.import_module("tml-solutions.tml-server-v1-plugin-ba1d.tml_system_step_8_deploy_solution_to_docker_dag-tml-server-v1-plugin-ba1d")
step9 = importlib.import_module("tml-solutions.tml-server-v1-plugin-ba1d.tml_system_step_9_privategpt_qdrant_dag-tml-server-v1-plugin-ba1d")
step10 = importlib.import_module("tml-solutions.tml-server-v1-plugin-ba1d.tml_system_step_10_documentation_dag-tml-server-v1-plugin-ba1d")


with DAG(
    dag_id="solution_preprocessing_ml_ai_restapi_dag-tml-server-v1-plugin-ba1d",
