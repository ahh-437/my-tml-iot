...
def setupurls(projectname,producetype,sname):
    ...
    stepurl10="https://github.com/{}/{}/tree/main/tml-airflow/dags/tml-solutions/{}/tml_system_step_10_documentation_dag_tml-multi-agenticai-iot-ba1d-{}.py".format(os.environ['GITUSERNAME'],tsslogging.getrepo(),projectname,projectname)
